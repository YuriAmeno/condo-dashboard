...
export function AppRoutes() {
  return (
    <Routes>
      ...
      {/* Protected Routes */}
      <Route element={<AuthGuard><BaseLayout /></AuthGuard>}>
        ...
        {/* Manager Only Routes */}
        <Route path="/doormen" element={<AuthGuard allowedRoles={['manager']}><Doormen /></AuthGuard>} />
        <Route path="/doormen/new" element={<AuthGuard allowedRoles={['manager']}><DoormanForm /></AuthGuard>} />
        <Route path="/doormen/:id" element={<AuthGuard allowedRoles={['manager']}><DoormanForm /></AuthGuard>} />
        <Route path="/doormen/:id/status" element={<AuthGuard allowedRoles={['manager']}><DoormanStatus /></AuthGuard>} />

        {/* Notifications */}
        <Route path="/notifications">
          <Route path="templates" element={<AuthGuard allowedRoles={['manager']}><NotificationTemplates /></AuthGuard>} />
